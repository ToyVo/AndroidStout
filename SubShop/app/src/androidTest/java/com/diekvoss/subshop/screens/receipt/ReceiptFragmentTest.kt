...
class ReceiptFragmentTest {
    ...
    fun testSandwich() {
        ...
        onView(withId(R.id.receipt_title_text)).check(ViewAssertions.matches(withText(R.string.receipt)))
        onView(withId(R.id.summary_text)).check(ViewAssertions.matches(withText("")))
        onView(withId(R.id.sandwich_type_text)).check(ViewAssertions.matches(withText(R.string.sandwich_type_philly)))
        onView(withId(R.id.bread_type_text)).check(ViewAssertions.matches(withText(R.string.bread_type_wheat)))
    }
    ...
    fun testSandwich1() {
        ...
        onView(withId(R.id.receipt_title_text)).check(ViewAssertions.matches(withText(R.string.receipt)))
        onView(withId(R.id.sandwich_type_text)).check(ViewAssertions.matches(withText(R.string.sandwich_type_bbq_chicken)))
        onView(withId(R.id.bread_type_text)).check(ViewAssertions.matches(withText(R.string.bread_type_flatbread)))
    ...
    fun testBackButton() {
        ...
        onView(ViewMatchers.withId(R.id.receipt_title_text)).check(ViewAssertions.matches(withText(R.string.receipt)))
        onView(ViewMatchers.withId(R.id.sandwich_type_text)).check(ViewAssertions.matches(withText(R.string.sandwich_type_italian)))
        onView(ViewMatchers.withId(R.id.bread_type_text)).check(ViewAssertions.matches(withText(R.string.bread_type_white)))
        onView(ViewMatchers.withId(R.id.summary_text)).check(ViewAssertions.matches(withText("with:\tMayo\n\tMustard\n")))

        onView(ViewMatchers.withId(R.id.summary_text)).perform(pressBack())
        onView(ViewMatchers.withId(R.id.order_button)).check(ViewAssertions.matches(withText(R.string.order_now_text)))
    }
}