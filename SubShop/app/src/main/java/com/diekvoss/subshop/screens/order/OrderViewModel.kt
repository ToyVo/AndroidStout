...
class OrderViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val sandwichTypes: MutableSet<SandwichItem> = mutableSetOf(
        SandwichItem(
    ...
    // set of bread types
    val breadTypes: MutableSet<SandwichItem> = mutableSetOf(
        SandwichItem(
    ...
    val toppingOptions: MutableSet<SandwichItem> = mutableSetOf(
        SandwichItem(
