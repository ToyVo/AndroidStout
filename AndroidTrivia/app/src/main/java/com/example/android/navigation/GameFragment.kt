...
/**
 * Fragment for the game
 * @property questions Questions to be asked in the game
 * @property currentQuestion current question displayed
 * @property answers answers corresponding the current question
 * @property questionIndex index of the current question
 * @property numQuestions number of questions to be asked depending on question possibilities
 */
class GameFragment : Fragment() {

    /**
     * simple data class for questions
     * @property text The question
    ...
    /**
     * Inflate the correct view to the container
     * set up buttons
