...
class ExampleRepository(application: Application) {
    ...
    fun getBooksByBookOrAuthor(searchQuery: String): LiveData<List<ExampleEntity>>? {
        return exampleDao.getBooksByBookOrAuthor(searchQuery)
    }
    ...
    companion object {
        private class InsertAsyncTask(private val exampleDao: ExampleDao) :
        ...
        private class UpdateAsyncTask(private val exampleDao: ExampleDao) :
            AsyncTask<ExampleEntity, Void, Unit>() {
        ...
        private class DeleteAsyncTask(private val exampleDao: ExampleDao) :
            AsyncTask<ExampleEntity, Void, Unit>() {
